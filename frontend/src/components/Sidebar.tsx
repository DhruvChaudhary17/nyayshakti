  ...
  return (
    <>
      <FloatingGlassButton
        ...
        position="top-right" className="text-lg font-bold">
        {language === 'en' ? '🇮🇳' : '🇺🇸'}
      </FloatingGlassButton>
                ...
                <GlassMorphCard hover className="p-4 rounded-xl">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => onTTSChange(!enableTTS)}
                      ...
                      <span className={clsx("absolute top-0.5 w-5 h-5 rounded-full bg-white shadow-lg transition-all duration-300",
